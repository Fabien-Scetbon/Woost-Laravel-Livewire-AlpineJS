                                        ...
                                        <table class="min-w-full table-fixed divide-y divide-gray-300">
                                            ...
                                            <tbody class="divide-y divide-gray-200 bg-white">
                                                ...
                                                <tr wire:click="redirectToControlUser( '{{ $user->id }}' )" wire:key="{{ $user->id }}" class="hover:bg-gray-100 hover:cursor-pointer">
                                                    ...
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 text-center">
                                                        <span wire:click.stop="setUserToDelete( {{ $user->id }} )"  x-on:click="openDeleteModal = true" class="inline-flex items-center rounded-full bg-red-100 px-2.5 py-0.5 text-xs font-medium text-red-700 hover:bg-red-500 hover:text-white hover:cursor-pointer">

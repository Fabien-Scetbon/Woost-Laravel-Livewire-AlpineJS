            ...
            <div class="p-10">
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="flex flex-row justify-between">
                        <h1 class="sm:text-base md:text-lg font-semibold text-gray-900 mb-2">Liste des tags</h1>
                    </div>
                                    ...
                                    <div class="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
                                        <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                                            ...
                                            <div class="flex gap-4">
                                                <select wire:model="showTag" id="tag" name="tag" class="rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                                            ...
                                            <tr>
                                                <td class="whitespace-nowrap pl-6 py-4 text-sm text-gray-500">
                                                    <div class="md:flex sm:w-48 mt-4 sm:mt-0">
                                                        <input wire:model.debounce.500ms="searchTag" type="text" class="block rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm mt-5 md:mt-0" placeholder="Rechercher un tag">
                                                    </div>
                                                </td>
